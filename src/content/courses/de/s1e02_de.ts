// src/content/courses/de/s1e02.ts
...
scene: {
  ...
  timestamp: ''
        ...
        { type: 'main', speaker: characters.amy, kind: 'amy-question', content: 'Für wen wurde der Chat unangenehm – und warum?', timestamp: '19:44' },
        { type: 'main', speaker: characters.amy, kind: 'amy-tip', content: 'Wenn die Stimmung im Chat kippt, gibt es oft nur noch Verlierer. Viele fühlen sich schlecht – auch die, die laut waren 😕', timestamp: '19:44' },
      ],
    },
...
scene: {
  ...
  id: "s1e02c02-0002",
  type: "main",
  speaker: { id: "lisa", name: "Lisa", avatar: "lisa" },
  content: "Und was hast du eigentlich in der Zeit gemacht? 😶 Soll ich dir auf die Sprünge helfen oder lieber nicht?",
  forwarded: {
    fromName: "Yasmin",
    fromChatLabel: "Klasse 7b"
  },
  timestamp: "19:31"
},
  ...
  speaker: { id: "lisa", name: "Lisa", avatar: "lisa" },
  content: "",
  image: '/media/story/episodes/s1e02/s1e02c02_2-512.webp',
  forwarded: {
    fromName: "Dominik",
    fromChatLabel: "Klasse 7b"
  },
  timestamp: "19:31"
        ...
        { type: 'main', speaker: characters.amy, kind: 'amy-question', content: 'Was könntest du tun, wenn in deinem Chat plötzlich Fake-Nachrichten auftauchen?', timestamp: '20:03' },
        { type: 'main', speaker: characters.amy, kind: 'amy-tip', content: 'Fake News werden nur stark, wenn man sie teilt oder liked. Deshalb: Nicht liken. Nicht teilen. Erst prüfen. Dann entscheiden 💡', timestamp: '20:03' },
      ],
    },
...
scene: {
  ...
  timestamp: '',
        ...
        { type: 'main', speaker: characters.amy, kind: 'amy-question', content: 'Warum fühlt es sich für Chioma mies an, nicht mehr im Klassenchat zu sein – obwohl dort viel Streit ist?', timestamp: '20:24' },
        { type: 'main', speaker: characters.amy, kind: 'amy-tip', content: 'Dazugehören ist für viele wichtig. Aber du musst dich nicht verstellen, um dabei zu sein. Es gibt auch andere Orte, an denen man dazugehören kann.', timestamp: '20:24' },
      {
  id: 's1e02c03-bonus-diary-yasmin-3',
  type: 'system',
  kind: 'bonus-link',
  content: 'Bonus: Möchtest du wissen, was Yasmin denkt?',
  linkTo: '/diaries/diary_yasmin?entry=s1e02c03_0001',
...
scene: {
  ...
  timestamp: '',
        ...
        { type: 'main', speaker: characters.amy, kind: 'amy-question', content: 'Challenge: Welche Ideen hättest du für einen Artikel in der Schülerzeitung?', timestamp: '13:13' },
        { type: 'main', speaker: characters.amy, kind: 'amy-tip', content: 'Wenn du dein Thema hast, hilft es, kurz festzuhalten, worum es dir dabei geht und warum es dir wichtig ist. 💡', timestamp: '13:13' },
      ],
    },
...
scene: {
  ...
  labelKey: 'stories:chatSwitch.private',
  title: '', // <- leer
  participants: [{name:'Lisa'}, {name:'Chioma'}],
},
  timestamp: '11:12',
},
  ...
  type: "main",
  speaker: { id: "lisa", name: "Lisa", avatar: "lisa" },
  content: "Chioma will mit mir über Regeln labern 😂  Die hat doch zero chance! Klickt rein und voted für mich 🔥",
  forwarded: {
    fromName: "Dominik",
    fromChatLabel: "Klasse 7b"
  },
  ...
  type: "main",
  speaker: { id: "lisa", name: "Lisa", avatar: "lisa" },
  content: "Ich bring Popcorn mit 😂🍿! Klare Sache, kannst auf mich zählen",
  image: '/media/story/episodes/s1e02/s1e02c02_2-512.webp',
  forwarded: {
    fromName: "Markus",
    fromChatLabel: "Klasse 7b"
  ...
  timestamp: "19:31"
        ...
        { type: 'other', speaker: characters.lisa, content: 'Was hast du vor? ', timestamp: '11:13' },
        { type: 'other', speaker: characters.lisa, content: 'Ich weiß nicht, ob das eine gute Idee ist. Glaubst du echt, du hast eine Chance gegen den?', timestamp: '11:13' },

        { type: 'main', speaker: characters.amy, kind: 'amy-question', content: 'Warum ist es wichtig, beide Seiten zu zeigen – und nicht nur die eigene Meinung?', timestamp: '10:02' },
        { type: 'main', speaker: characters.amy, kind: 'amy-tip', content: 'Fair ist, wenn alle ihre Sicht sagen dürfen. Nur so kann man wirklich verstehen, worum es geht.', timestamp: '10:02' },
      ],
    },
...
scene: {
  ...
  timestamp: '',
        ...
        { type: 'main', speaker: characters.chioma, content: 'Ist ja gut. Was hältst du von dem Audioformat?', timestamp: '12:15' },
        { type: 'main', speaker: characters.chioma, content: 'In einem Chat ohne Regeln gewinnt der Lautere, der Fiesere, der Admin, der andere rauswerfen kann.', timestamp: '12:15' },
        { type: 'main', speaker: characters.chioma, content: 'In einem Gespräch muss jeder dem anderen zuhören.', timestamp: '12:15' },
        { type: 'other', speaker: characters.carlos, content: 'Du willst das Spielfeld ändern 🤔', timestamp: '12:13' },
        { type: 'main', speaker: characters.chioma, content: 'Genau?', timestamp: '12:15' },
        { type: 'other', speaker: characters.carlos, content: 'Nicht schlecht.', timestamp: '12:13' },
        { type: 'other', speaker: characters.carlos, content: 'Aber nur damit das klar ist ⚠️', timestamp: '12:13' },
        { type: 'other', speaker: characters.carlos, content: 'Sobald das online ist, können wir es nicht einfach wieder zurückholen.', timestamp: '12:13' },
        { type: 'main', speaker: characters.chioma, content: 'Ich weiß 🙂', timestamp: '12:15' },
        { type: 'other', speaker: characters.carlos, content: 'Nein, ich meine ernsthaft.', timestamp: '12:13' },
        { type: 'other', speaker: characters.carlos, content: 'Das hören nicht nur deine Freunde. Das hören alle.', timestamp: '12:13' },
        { type: 'other', speaker: characters.carlos, content: 'Und wenn es kippt, kriegen es alle mit.', timestamp: '12:13' },
        { type: 'main', speaker: characters.chioma, content: 'Genau deshalb.', timestamp: '12:15' },
        { type: 'main', speaker: characters.chioma, content: 'Wenn es kippt, sehen es alle.', timestamp: '12:15' },
        { type: 'other', speaker: characters.carlos, content: 'Entiendo. Ich verstehe.', timestamp: '12:13' },
        ...
        { type: 'main', speaker: characters.amy, kind: 'amy-question', content: 'Wobei hast du erlebt, dass etwas zusammen besser klappt als allein?', timestamp: '12:18' },
        { type: 'main', speaker: characters.amy, kind: 'amy-tip', content: 'Wenn etwas zusammen besser klappt, liegt das oft daran, dass jede Person etwas anderes gut kann. 💡', timestamp: '12:18' },
      ],
    },
...
// ------------------------------------
{
  ...
  messages: [
    ...
    { id: 's1e02c07-0002', type: 'other', speaker: characters.carlos, content: 'Ich hab den Beitrag fertig geschnitten.', timestamp: '16:30', reactions: [R('🙏')] },

    { id: 's1e02c07-0003', type: 'other', speaker: characters.carlos, content: 'Hier der Link zum Audiobeitrag', timestamp: '16:31' },
    {
    ...
    { id: 's1e02c07-0004', type: 'other', speaker: characters.carlos, content: '@Chioma: Dann kannst du noch die Anmoderation dazu schreiben, wenn du magst.', timestamp: '16:31' },

    { id: 's1e02c07-0005', type: 'other', speaker: characters.dominik, content: 'Anmoderation?', timestamp: '16:32' },
    { id: 's1e02c07-0006', type: 'other', speaker: characters.carlos, content: 'Ja, den Teaser, die Einleitung.', timestamp: '16:32' },
    { id: 's1e02c07-0007', type: 'main', speaker: characters.chioma, content: 'Ist gut, mach ich 🙂.', timestamp: '16:33' },

                {
  id: "s1e02c07-0002",
  type: "main",
  speaker: { id: "carlos", name: "Carlos", avatar: "carlos" },
  content: "Hier der Link zum Audiobeitrag...",
  forwarded: {
    fromName: "Carlos",
    fromChatLabel: "Klasse 7b"
  },
  timestamp: "16:33"
    ...
    { id: 's1e02c07-0008', type: 'other', speaker: characters.carlos, content: 'Passt so?', timestamp: '16:34' },
    { id: 's1e02c07-0009', type: 'main', speaker: characters.chioma, content: 'Ja.', timestamp: '16:34' },

    { id: 's1e02c07-0010', type: 'system', image: '/media/story/episodes/s1e02/s1e02c07-512.webp', timestamp: '' },

    { id: 's1e02c07-0011', type: 'other', speaker: characters.dominik, content: 'Klar, das wird easy. Ey Chioma, das wird maximal cringe für dich 🤣', timestamp: '16:35', reactions: [R('🤣')] },
    { id: 's1e02c07-0012', type: 'other', speaker: characters.dominik, content: 'Und, wann geht das live?', timestamp: '16:36' },
    { id: 's1e02c07-0013', type: 'other', speaker: characters.carlos, content: 'Morgen, Punkt 15:00 Uhr wird alles freigeschaltet.', timestamp: '16:36' },

    { id: 's1e02c07-0014', type: 'system', content: 'Dominik left', timestamp: '16:37' },

    {
      ...
      content:
        'Ich hab zum Artikel schon ´ne kleine Umfrage gebastelt. Schau mal rein: „zur Umfrage” (https://docs.google.com/forms/d/e/1FAIpQLSfBs-oBN5hBBe1PcwCjlZaIAe-hCDk2huriKZZbQVC9CJMpoQ/viewform?usp=publish-editor)',
      timestamp: '16:38',
      reactions: [R('🙏')],
    },

    { id: 's1e02c07-0016', type: 'main', speaker: characters.chioma, content: 'Was, wenn mich morgen alle auslachen?', timestamp: '16:39' },

    { id: 's1e02c07-0017', type: 'main', speaker: characters.carlos, content: 'Carlos´ Extra-Tipp: Meine Mini-Anleitung: So wird aus einer Idee ein echter Audio-Beitrag', timestamp: '16:40' },
    ...
    {
      id: 's1e02c07-bonus-tip-carlos-audio-howto',
      type: 'system',
      kind: 'bonus-link',
      content: '📰 Bonus: Carlos erklärt, wie du ein gutes Audio machst – ohne Stress im Team.',
      linkTo: '/newspaper/tip-carlos-audio-howto',
      linkLabel: 'Artikel öffnen →',
      bonusId: 'tip-carlos-audio-howto',
    },

    // Reflexion
    { id: 's1e02c07-0018', type: 'main', speaker: characters.amy, kind: 'amy-question', content: 'Warum wärst du eher für Chatregeln – oder warum eher dagegen?', timestamp: '16:41' },
    { id: 's1e02c07-0019', type: 'main', speaker: characters.amy, kind: 'amy-tip', content: 'Gute Regeln sollen schützen. Sie sollen helfen, nicht nerven.', timestamp: '16:41' },
  ],
},
...
scene: {
  ...
  timestamp: '',
        ...
        { type: 'main', speaker: characters.amy, kind: 'amy-question', content: 'Wie fühlt sich Chioma in diesem Kapitel – und welche Emojis passen dazu?', timestamp: '14:53' },
        { type: 'main', speaker: characters.amy, kind: 'amy-tip', content: 'Wenn du Gefühle anderer erkennst, kannst du besser reagieren. Manchmal helfen Emojis.', timestamp: '14:53' },
      ],
    },
...
scene: {
  ...
  timestamp: '',
        ...
        { type: 'main', speaker: characters.amy, kind: 'amy-question', content: 'Was könnte passieren, wenn Artikel veröffentlicht werden, ohne sie vorher zu prüfen?', timestamp: '15:01' },
        { type: 'main', speaker: characters.amy, kind: 'amy-tip', content: 'Wer veröffentlicht, trägt Verantwortung. Eine zweite Meinung hilft, damit Beiträge fair und glaubwürdig bleiben – und niemand verletzt wird.', timestamp: '15:01' },
      ],
    },
...
scene: {
  ...
  timestamp: '',
        ...
        { type: 'main', speaker: characters.amy, kind: 'amy-question', content: 'Was würdest du dir in einem Chat wünschen, damit sich alle sicher fühlen?', timestamp: '15:20' },
        { type: 'main', speaker: characters.amy, kind: 'amy-tip', content: 'Sicherheit entsteht, wenn man respektvoll miteinander umgeht. Gute Absprachen helfen dabei. 💡 Schau dir gern Chiomas Vorschlag an und überlege, was dir helfen würde.', timestamp: '15:20' },
{
  id: 's1e02c10-bonus-tip-chioma-groupchats',
  type: 'system',
  kind: 'bonus-link',
  content: 'Bonus: Chioma zeigt Gruppenchat-Regeln, die echt Frieden bringen können.',
  linkTo: '/newspaper/tip-chioma-groupchats',
  linkLabel: 'Artikel öffnen →',

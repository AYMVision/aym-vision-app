...
export const LEXIKON_ENTRIES: LexikonEntry[] = [
  {
    ...
    body: 'Ein Algorithmus ist eine genaue Abfolge von Regeln, nach denen ein Programm entscheidet. Bei Social-Media-Apps entscheidet er zum Beispiel, welche Videos du zuerst siehst — basierend auf dem, was du bisher angeschaut, geliked oder länger betrachtet hast. Für die Klassenlehrerin gesagt: stell dir ein sehr detailliertes Kochrezept vor, das die App im Kopf hat. Je mehr sie über deinen Geschmack weiß, desto besser "kocht" sie für dich — aber nicht immer, was gut für dich ist.',
  ...
  },
  {
    ...
    body: 'Bei einer normalen Suche gibst du Wörter ein. Bei einer Rückwärtsbildsuche gibst du stattdessen ein Bild ein — und die Suchmaschine findet heraus, wo dieses Bild sonst noch im Internet auftaucht. Das ist nützlich, um Fake-Bilder zu entlarven, den Ursprung eines Fotos zu finden oder herauszufinden, ob jemand ein fremdes Foto benutzt. Google Bilder und TinEye bieten das an.',
  ...
  },
  {
    id: 'screen-time',
    title: 'Screen Time',
    teaser: 'Die Zeit, die man täglich mit Bildschirmen verbringt.',
  ...
  },
  {
    ...
    body: 'Ein Screenshot (auch: Bildschirmfoto) hält fest, was auf dem Display angezeigt wird — als Bild. Das klingt simpel, hat aber Konsequenzen: Nachrichten, die als "verschwindend" oder "privat" markiert sind, können trotzdem per Screenshot festgehalten und weitergeschickt werden. Viele Missverständnisse und Streitigkeiten entstehen durch Screenshots, die aus dem Kontext gerissen werden.',

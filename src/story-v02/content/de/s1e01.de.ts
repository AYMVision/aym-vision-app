...
const c01 = C('s1e01c01', 0, 'Amic 1', 'Sommerferien', [
  ...
  S('s1e01c01_story_switch_to_amy_chat', [
    amyChat(),
    m(ch.amy, 'Keine Sorge: Antwort einfach ehrlich. Ich bin neugierig, was du denkst.'),
  ], ['reflect-understand']),
...
const c04 = C('s1e01c04', 3, 'Amic 4', 'Am Wasserfall', [
  ...
  S('s1e01c04_story_lukas_friendbook', [
    ...
    m(ch.lukas, 'Hi {{chatName}}, ich habe mich in deinem Freundebuch verewigt.', '15:40'),
...
const c06 = C('s1e01c06', 5, 'Amic 6', 'Spuren im Bild', [
  ...
  CH('s1e01c06_challenge_metadata',
    '👉 Schau dir heute ein Foto an, das du teilen würdest – weißt du, welche unsichtbaren Infos darin stecken könnten?',
  ),
]);

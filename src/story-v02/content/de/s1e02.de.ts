...
audio(ch.carlos, 'media/newspaper/articles/chatrules-chioma-dominik/audio.mp3', '14:31', 'Audiobeitrag'),
  ...
  OR('s1e02c07_reflection_rules_why',
    'Warum?',
    {
      ...
      category: 'PERSPECTIVE',
      bypassAi: true,
      fixedAmyReply: 'Gute Regeln sollen schützen, nicht nerven. Und dabei helfen, dass sich niemand ausgeschlossen fühlt.',
...
const c08 = C('s1e02c08', 7, 'Amic 8', 'Regeln gelten auch hier', [
  ...
  S('s1e02c08_story_student_newsroom_rule_conflict', [
    ...
    m(ch.aylin, '📋 Bitte abhaken, wenn ihr Alvarez´ Bestätigung eingeholt habt:\n☐ Carlos\n☐ Jonas\n☐ Chioma', '14:47'),
...
audio(ch.carlos, 'media/newspaper/articles/chatrules-chioma-dominik/audio.mp3', '15:43', 'Audiobeitrag'),
    ...
    m(ch.dominik, 'Grrr. Und dein hauchdünner Vorsprung heißt jetzt, ich darf nicht mehr schreiben, was ich will?', '15:48'),
    m(ch.chioma, 'Niemand wird gezwungen, hier zu bleiben. Aber wer bleibt, hält sich dran.', '15:48'),
    m(ch.dominik, 'Hält sich woran??', '15:49'),
    m(ch.chioma, 'An das, was wir gemeinsam abstimmen.', '15:49'),
  ], ['fairness', 'talk-act', 'problem-solving']),

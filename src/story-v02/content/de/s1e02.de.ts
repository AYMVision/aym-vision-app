...
const c03 = C('s1e02c03', 2, 'Amic 3', 'Dazugehören', [
  ...
  S('s1e02c03_story_after_item_private', [
    ...
    m(ch.chioma, 'Wieso?', '11:21'),
    m(ch.jonas, 'Es macht echt Spaß und man hat das Gefühl, nicht nur rumzusitzen.', '11:21'),
    m(ch.chioma, 'Meinst du echt?', '11:21'),
    m(ch.jonas, 'Klar. 😊', '11:22'),
    m(ch.jonas, 'Deine Weeklys gibst du uns doch eh schon. Komm doch mal mit zur Redaktion. Wir sitzen immer Dienstags zusammen.', '11:22'),
    m(ch.jonas, 'Hast du Lust?', '11:22'),
    m(ch.chioma, 'Ja, Lust hab ich schon.', '11:23'),
    m(ch.chioma, 'Aber was, wenn die jetzt auch sauer auf mich sind?', '11:23'),
...
const c04 = C('s1e02c04', 3, 'Amic 4', 'Die Schülerzeitung', [
  ...
  S('s1e02c04_story_student_newsroom', [
    ...
    m(ch.chioma, 'Ja, aus Rachegelüsten bin ich nicht hier. Aber einfach den Mund verbieten lasse ich mir auch nicht.', '12:07'),
...
const c05 = C('s1e02c05', 4, 'Amic 5', 'Die Debatte', [
  ...
  S('s1e02c05_story_lisa_forwarded', [
    ...
    m(ch.lisa, 'Chioma will mit mir über Regeln labern 😂 Die hat doch zero chance! Klickt rein und voted für mich 🔥', '13:40', { forwarded: { fromChatLabel: 'Klassenchat' } }),
    m(ch.lisa, 'Ich bring Popcorn mit! 😂🍿 Klare Sache, kannst auf mich zählen.', '13:40', { forwarded: { fromChatLabel: 'Klassenchat' } }),

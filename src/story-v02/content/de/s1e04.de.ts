...
const c01 = C('s1e04c01', 0, 'Amic 1', 'Am Skatepark', [
  ...
  S('s1e04c01_story_classChat_skatepark', [
    classChat(),
    m(ch.mia, '@ Finn: Wir waren doch um 15:30 verabredet.', '15:58'),
    m(ch.mia, 'Wo bist du?', '15:58'),
    m(ch.tom, 'Sag bitte nicht wieder „bin gleich da"…', '15:59'),
    m(ch.finn, 'bin gleich da 😉', '16:00'),
    m(ch.mia, '… hoffentlich 😅', '16:00'),
    m(ch.tom, 'Du spielst noch, oder?', '16:01'),
    m(ch.finn, 'nein nein', '16:01'),
    img(ch.tom, 'media/story/episodes/s1e04/s1e04c01-512.webp', '16:04', { reactions: [R('👍'), R('🔥')] }),
    m(ch.yasmin, 'Schickt mir jemand die Adresse?', '16:05'),
    m(ch.tom, 'Hab ich dir privat geschickt.', '16:06'),
    m(ch.tom, 'Cool, dass du auch mal kommst 👍', '16:06'),
    m(ch.elsa, 'Yasmin liked das Foto aber schnell 😂', '16:07', { replyTo: { speakerName: 'Tom', text: '📷' } }),
    m(ch.dominik, 'Sie kommt doch nur für den Typen auf dem Foto 😏', '16:08'),
    m(ch.elsa, '💋💋', '16:08'),
    m(ch.yasmin, 'Gar nicht. 🙄', '16:09'),
    m(ch.yasmin, 'Ich hab einfach Bock.', '16:09'),
    m(ch.dominik, 'Wer´s glaubt.', '16:09'),
    m(ch.tom, 'Ist richtig voll heute.', '16:12'),
    m(ch.tom, 'Es ist gefühlt die halbe Schule hier.', '16:12'),
    m(ch.farida, 'Wie schön.', '16:13'),
    m(ch.farida, 'Kann man da auch einfach mal zugucken?', '16:13'),
    m(ch.mia, 'Klar 🙂', '16:14'),
    m(ch.mia, 'Komm vorbei.', '16:14'),
    m(ch.amir, 'Klingt interessant.', '16:15'),
    m(ch.dominik, '😐', '16:16'),
    m(ch.dominik, 'Und was habt ihr da verloren?', '16:16'),
    m(ch.dominik, 'Was wollt ihr überhaupt hier bei uns??', '16:17'),
    m(ch.igor, '@Dominik: Was willst du damit sagen?', '16:17'),
    m(ch.markus, 'Ohhh 😏', '16:18'),
    m(ch.markus, 'Das wird spannend.', '16:18'),
    m(ch.igor, 'Das ist ein öffentlicher Skatepark. Kein Club.', '16:18'),
    m(ch.igor, '@Farida @Amir: Klar könnt ihr kommen.', '16:19'),
    m(ch.dominik, 'Ja klar.', '16:19'),
    m(ch.dominik, 'Kommt ruhig 😂', '16:20'),
    m(ch.dominik, 'Dann sehen wir ja, wie gut ihr hier reinpasst.', '16:20'),
    m(ch.dominik, '@Mia: Amir kann ja Finns Platz einnehmen. Der kommt eh nicht mehr. 😂', '16:21'),
    m(ch.mia, '🙄', '16:21'),
  ], ['reflect-understand', 'fairness']),

  S('s1e04c01_story_farida_amir_1', [
    privateChat('Farida', 'Amir'),
    m(ch.farida, 'Gehst du?', '16:23'),
    m(ch.amir, 'Weiß nicht.', '16:24'),
    m(ch.farida, 'Ich glaub, ich trau mich nicht. Außer du gehst… dann vielleicht.', '16:24'),
  ], ['reflect-understand']),
  ...
  S('s1e04c01_story_farida_amir_2', [
    m(ch.amir, 'Was hat das mit mir zu tun?', '16:25'),
    m(ch.farida, 'Naja… wir könnten zusammen hingehen.', '16:26'),
    m(ch.amir, 'Wozu? Die denken noch, wir sind ein Paar.', '16:27'),
    m(ch.farida, 'Allein trau ich mich nicht.', '16:28'),
    m(ch.farida, 'Was, wenn Dominik wieder so ist?', '16:28'),
    m(ch.amir, 'Der ist immer so.', '16:29'),
    m(ch.amir, 'Auch wenn ich dabei bin.', '16:29'),
    m(ch.amir, 'Dann geh halt lieber nicht.', '16:30'),
    m(ch.farida, 'Oh.', '16:31'),
    m(ch.amir, 'Ich mein doch nur…', '16:32'),
    m(ch.amir, '… dass Dominik nicht plötzlich nett wird.', '16:32'),
    m(ch.farida, 'Ach so.', '16:33'),
    m(ch.farida, 'Ich will da nicht irgendwie… auffallen.', '16:34'),
    m(ch.amir, 'Du fällst sowieso auf.', '16:35'),
    m(ch.amir, 'Weil du neu bist.', '16:35'),
    m(ch.farida, '😶', '16:36'),
    m(ch.amir, 'Ich ja auch.', '16:37'),
    m(ch.amir, 'Alle denken, weil wir beide neu sind,…', '16:37'),
    m(ch.amir, '… sind wir gleich.', '16:38'),
    m(ch.farida, 'Was meinst du?', '16:39'),
    m(ch.amir, 'Als würden wir automatisch zusammen gehören.', '16:40'),
    m(ch.farida, '…', '16:41'),
    m(ch.farida, 'Ich hab das gar nicht so gedacht.', '16:42'),
    m(ch.farida, 'Wir sind doch nicht mal aus dem gleichen Land.', '16:42'),
    m(ch.amir, 'Die anderen schon.', '16:43', {
      replyTo: { speakerName: 'Farida', text: 'Ich hab das gar nicht so gedacht.' },
    }),
    m(ch.farida, 'Ich will einfach nur kurz schauen.', '16:45'),
    m(ch.amir, 'Und ich hab keine Lust, mich da hinzustellen und nett zu lächeln, damit es für alle passt.', '16:46'),
    m(ch.farida, 'Aber ich hab auch keine Lust auf Stress.', '16:47'),
    m(ch.amir, 'Dann geh nicht.', '16:47'),
    m(ch.farida, 'Die sind doch bestimmt nicht alle so.', '16:48'),
    m(ch.amir, 'Es reicht ja einer.', '16:49'),
    m(ch.amir, 'Und die anderen sagen nichts.', '16:49'),
    divider('…'),
    m(ch.farida, 'Und, kommst du?', '16:52'),
  ], ['reflect-understand', 'fairness']),
...
const c02 = C('s1e04c02', 1, 'Amic 2', 'Kommt Finn noch?', [
  ...
  S('s1e04c02_story_classChat_finn_arrives', [
    classChat(),
    m(ch.dominik, 'Ich glaub, unser Gamer hängt wieder fest. Zockt er oder mäht er wieder Schuberts Rasen? 😂', '17:32'),
    m(ch.mia, '😳', '17:33'),
    m(ch.finn, 'bin da', '17:34'),
    m(ch.finn, 'Wo??', '17:34'),
    img(ch.igor, 'media/story/episodes/s1e04/s1e04c02_1-512.webp', '17:35', { reactions: [R('👍')] }),
    m(ch.mia, '😄', '17:36'),
    m(ch.mia, 'Du hast es wirklich geschafft.', '17:36'),
    m(ch.tom, 'Ich bin überrascht.', '17:37'),
    m(ch.finn, '😒', '17:37'),
    m(ch.finn, 'habt ihr was anderes von mir erwartet?', '17:38'),
    m(ch.dominik, '😂', '17:38'),
    m(ch.mia, '🙄', '17:39'),
    m(ch.finn, 'genug gelabert. los gehts', '17:39'),
    img(ch.igor, 'media/story/episodes/s1e04/s1e04c02_2-512.webp', '17:44', { reactions: [R('🔥')] }),
    m(ch.yasmin, '😳🔥🔥', '17:45'),
    m(ch.yasmin, 'Das sieht richtig gut aus.', '17:45'),
    img(ch.yasmin, 'media/story/episodes/s1e04/s1e04c02_3-512.webp', '17:48'),
    m(ch.elsa, 'Solltest du im Skatepark nicht lieber ein Stunt-Foto von dir schicken? 😘😘', '17:49'),
    typing('Yasmin tippt'),
    typing('Yasmin löscht'),
    m(ch.dominik, '@Elsa: Yasmin macht die Deko für Igor 😂', '17:51'),
  ], ['reflect-understand', 'fairness']),

  S('s1e04c02_story_yasmin_lisa', [
    privateChat('Yasmin', 'Lisa', 'Du'),
    m(ch.yasmin, 'Was dissen die mich ständig wegen Igor? Sieht es echt so aus, als wenn ich ihn gut finde?', '17:53'),
    m(ch.lisa, 'Naja, schon ein bisschen 😄', '17:54'),
    m(ch.yasmin, 'Aber… stimmt ja gar nicht!', '17:55'),
    m(ch.lisa, 'Nein, gaaar nicht 😉', '17:55'),
    m(ch.yasmin, 'Fang du nicht auch an.', '17:56'),
    m(ch.lisa, 'Nur Spaß! Hör nicht auf die.', '17:57'),
    m(ch.yasmin, 'Alle kriegen 1000 Likes auf ihre Fotos.', '18:02'),
    m(ch.yasmin, 'Nur ich krieg keine.', '18:02'),
    typing('Yasmin löscht Nachricht'),
    m(ch.yasmin, 'Kennst du auch das Gefühl?', '18:03'),
  ], ['reflect-understand']),
  ...
  S('s1e04c02_story_classChat_farida_arrives', [
    classChat(),
    m(ch.farida, 'Wir finden nicht den Platz.', '18:15'),
    m(ch.dominik, 'Das muss ein Zeichen sein. 👀', '18:15'),
    img(ch.igor, 'media/story/episodes/s1e04/s1e04c02_4-512.webp', '18:16', { reactions: [R('❤️')] }),
    m(ch.igor, 'Von der Bushaltestelle aus siehst du einen Basketball-Court. Gleich dahinter ist der Skatepark.', '18:16'),
    m(ch.dominik, 'Ihr habt euch ja doch getraut.', '19:07', { reactions: [R('😂')] }),
    m(ch.markus, 'Respekt 😂', '19:08'),
    m(ch.amir, 'Interessant, wie viele lachen, obwohl nichts lustig ist.', '19:09', { reactions: [R('👍')] }),
    m(ch.dominik, 'Also Amir…', '19:10'),
    m(ch.dominik, 'Wenn du alles besser weißt…', '19:10'),
    m(ch.amir, 'Ich hab nie gesagt, dass ich besser weiß.', '19:11'),
    m(ch.dominik, '„Dass ich besser weiß" 😂 Was ist das für ein Deutsch?', '19:12'),
    m(ch.dominik, 'Nimm lieber ein paar Privatstunden nach der Schule. 📖', '19:12'),
    m(ch.amir, 'Dich geht meine Freizeit gar nichts an! 💢', '19:13'),
    m(ch.dominik, 'Wow. Da hat wohl jemand Probleme mit der Selbstkontrolle 😂😤', '19:14'),
  ], ['fairness', 'talk-act']),
  ...
  S('s1e04c02_story_carlos_jonas_user', [
    m(ch.carlos, 'Hab Amir gestern bei der Bank gesehen. Der hat für seine Eltern alles übersetzt.', '19:20'),
    m(ch.jonas, 'Im Ernst? Meine Eltern helfen immer mir. Nicht anders herum.', '19:21'),
    m(ch.carlos, 'Igual. Bei mir auch. Aber wenn sie es halt nicht können…', '19:22'),
    m(ch.jonas, 'Das muss schwierig sein. Dass er sich gar nicht beschwert. 🤔', '19:23'),
    m(ch.carlos, 'Naja, was hat er für eine Wahl?', '19:24'),
  ], ['reflect-understand']),

  S('s1e04c02_story_jonas_user_freundebuch', [
    privateChat('Jonas', 'Du'),
    m(ch.jonas, 'Hey, ich hab in dein Freundebuch geschrieben.', '19:28'),
...
const c06 = C('s1e04c06', 5, 'Amic 6', 'Der Sportbeutel', [
  ...
  S('s1e04c06_story_classChat_sportbeutel', [
    classChat(),
    sysImg('media/story/episodes/s1e04/s1e04c06_1_a-512.webp', '08:13'),
    m(ch.finn, 'hat jemand meine sportsachen gesehen? 🤔', '08:15'),
    m(ch.finn, 'hab sie eben gerade in der umkleide vergessen. bin grad zurück gelaufen', '08:15'),
    m(ch.finn, 'sie sind weg', '08:16'),
    m(ch.dominik, 'Kannst du nicht auf deine Sachen aufpassen?', '08:17'),
    m(ch.markus, 'Mir wurde letzte Woche auch was aus der Turnhalle geklaut. 👀', '08:18'),
    m(ch.finn, 'echt jetzt?', '08:19'),
    m(ch.finn, 'wenn meine neuen schuhe weg sind, gibts ärger zu hause', '08:19'),
    m(ch.mia, 'Vielleicht im Geräteraum oder schon im Fundbüro? 🤔', '08:20'),
    divider('… etwas später'),
    m(ch.finn, 'nein. nichts.', '08:35'),
    divider('…'),
    m(ch.markus, 'Wo ist Amir eigentlich?', '08:40'),
    m(ch.dominik, '😏', '08:41'),
    m(ch.igor, 'Was soll das heißen?', '08:42'),
    m(ch.dominik, 'Ach komm. Das passt doch.', '08:43'),
    m(ch.amir, 'Was passt?', '08:44'),
    m(ch.dominik, 'Wo bist du grad?', '08:45'),
    m(ch.amir, 'Vor der Klasse.', '08:45'),
    m(ch.dominik, '@Finn: Wir haben deinen Beutel!', '08:52'),
    m(ch.dominik, '3 Mal darfst du raten, wer ihn hatte. 💀', '08:52'),
    m(ch.elsa, 'Amir?', '08:53'),
    m(ch.dominik, 'Bingo 🏆', '08:53'),
    m(ch.dominik, 'Er hat ihn geklaut.', '08:53'),
    m(ch.amir, 'Ich hab nichts geklaut.', '08:54'),
    m(ch.dominik, 'Klar hast du.', '08:55'),
    sysImg('media/story/episodes/s1e04/s1e04c06_2-512.webp', '08:55'),
    m(ch.dominik, 'Markus und ich haben dich doch grad auf frischer Tat ertappt.', '08:55'),
    m(ch.dominik, 'Genau vor der Klasse, mit Finns Sportbeutel.', '08:56'),
    m(ch.amir, 'Lasst mich in Ruhe.', '08:57'),
    m(ch.markus, 'Na, hattest du den Sportbeutel oder nicht?', '08:58'),
    m(ch.amir, 'Ja.', '08:59'),
    m(ch.finn, 'echt??', '09:00'),
    m(ch.emma, '👀', '09:00'),
    m(ch.lisa, 'Vielleicht hat er ihn aus Versehen mitgenommen?', '09:01'),
    m(ch.markus, 'Ja klar. „Aus Versehen" 😂', '09:01'),
    m(ch.dominik, 'Erst Stress machen und dann Sachen klauen', '09:02'),
    m(ch.dominik, 'und dann einen auf „ich war\'s nicht" 😂', '09:03'),
    m(ch.markus, 'Und meine Sachen?', '09:03'),
    m(ch.markus, 'Rück sofort meine Sachen raus, du Dieb! 💪', '09:04'),
    m(ch.amir, 'Ich hab nichts von dir.', '09:04'),
    m(ch.lisa, 'Vielleicht stimmt es ja…', '09:05'),
    m(ch.markus, 'Blödsinn. Gestern hatte Amir genau die gleichen Socken an.', '09:06'),
    m(ch.dominik, 'Das wird ja immer besser. 💀💀💀', '09:07'),
    m(ch.mia, 'Was? Ein Dieb in unserer Klasse?', '09:08'),
    m(ch.emma, 'Das hört man jetzt überall.', '09:08'),
    m(ch.emma, 'Fast schon wie ne Mafia 👀', '09:09'),
    m(ch.igor, 'Hast du wieder zu viel TikTok gesehen?', '09:09'),
    m(ch.emma, 'Hm, vielleicht auch das.', '09:10'),
    m(ch.markus, 'Hey, was ist jetzt mit meinen Strümpfen?', '09:11'),
    m(ch.igor, '😂 Chill, die Socken gibt\'s überall. Jeder kann die haben.', '09:11'),
    m(ch.chioma, 'Jetzt wartet doch mal.', '09:12'),
    m(ch.chioma, 'Vielleicht ist das nur ein Missverständnis.', '09:12'),
    m(ch.dominik, 'Oder vielleicht auch nicht.', '09:13'),
    m(ch.farida, 'Amir?', '09:14'),
    typing('Amir schreibt'),
    typing('Amir löscht'),
    m(ch.amir, 'Jemandem wie mir glaubt doch eh niemand.', '09:16'),
    m(ch.markus, 'Und meine Sachen?', '09:17'),
    m(ch.markus, 'Ich geh zur Schulleiterin!', '09:20'),
...
const c07 = C('s1e04c07', 6, 'Amic 7', 'Mehr als Stress', [
  ...
  S('s1e04c07_story_carlos_jonas_aylin_amt', [
    ...
    m(ch.carlos, 'Ich war gestern mit meiner Mutter beim Amt.', '20:05'),
    m(ch.aylin, 'Und?', '20:06'),
    m(ch.carlos, 'Da hab ich Amir gesehen.', '20:06'),
    img(ch.carlos, 'media/story/episodes/s1e04/s1e04c07-512.webp', '20:06'),
    m(ch.jonas, 'Hattest du ihn nicht neulich schon mit seinen Eltern bei der Bank gesehen?', '20:07'),
    m(ch.carlos, 'Ja, richtig.', '20:08'),
    m(ch.carlos, 'Er hat wieder die ganze Zeit für seine Eltern übersetzt.', '20:08'),
    m(ch.carlos, 'Die hatten voll viele Briefe dabei.', '20:09'),
    m(ch.carlos, 'Und irgendwas wurde nicht genehmigt.', '20:09'),
    m(ch.carlos, 'Seine Eltern waren komplett fertig.', '20:10'),
    m(ch.jonas, 'Und er?', '20:11'),
    m(ch.carlos, 'Er musste das alles übersetzen und erklären.', '20:12'),
    m(ch.jonas, 'Aber versteht er das überhaupt alles?', '20:13'),
    m(ch.carlos, 'Keine Ahnung.', '20:13'),
    m(ch.aylin, 'Krass.', '20:14'),
    m(ch.jonas, 'Und das nach dem ganzen Stress in der Schule.', '20:15'),
    m(ch.carlos, 'Die Familie hat nichts mehr. Und jetzt solche Probleme.', '20:16'),
    m(ch.carlos, 'Da weiß man sich vielleicht echt nicht mehr anders zu helfen…', '20:17'),
    m(ch.aylin, 'Was meinst du?', '20:18'),
    m(ch.carlos, 'Naja, vielleicht kommt man da auf dumme Gedanken.', '20:18'),
    m(ch.jonas, 'Was? 😮', '20:19'),
    m(ch.carlos, 'Naja, ich versteh ihn irgendwie.', '20:20'),
    m(ch.jonas, 'Du jetzt auch noch?', '20:21'),
    m(ch.jonas, 'Es ist doch gar nicht gesagt, dass er geklaut hat!', '20:21'),
    m(ch.carlos, 'Hoffentlich nicht.', '20:22'),
    m(ch.carlos, 'Ich muss los Leute. Hasta luego.', '20:23'),
    sysMsg('Carlos hat den Chat verlassen.', '20:23'),
  ], ['reflect-understand', 'info-check']),
  ...
  IT('s1e04c07_item_amir_family',
    ...
    [
      ...
      optSegs('d', 'Jetzt wissen wir zwar mehr über Amirs Situation, aber mit dem Sportbeutel hat das erstmal nichts zu tun.', 3,
        'Gut. Du trennst die Informationen voneinander. Genau so bleibst du fair: Du nimmst neue Infos ernst, aber vermischst sie nicht mit der eigentlichen Frage.',
  ...
  S('s1e04c07_story_jonas_aylin', [
    ...
    m(ch.aylin, 'Ich verabschiede mich auch. Muss Chioma noch schreiben.', '20:25'),
    m(ch.jonas, 'Ich wusste gar nicht, dass ihr auch außerhalb der Redaktion in Kontakt seid.', '20:26'),
    m(ch.aylin, 'Nicht viel, aber gestern hab ich ihr gesagt, dass ich mich um den Termin mit Alvarez kümmere.', '20:27'),
    m(ch.jonas, 'Ach ne. 😅', '20:28'),
    m(ch.jonas, 'Habt ihr auch über mich geredet?', '20:28'),
    m(ch.aylin, 'Über dich? Wieso?', '20:29'),
    m(ch.aylin, 'Ja, haben wir tatsächlich.', '20:29'),
    m(ch.jonas, 'Echt? 🧐', '20:30'),
    m(ch.jonas, 'Was denn?', '20:30'),
    m(ch.aylin, 'Naja, ich dachte, zwischen euch läuft vielleicht was.', '20:31'),
    m(ch.jonas, 'Und hast du sie gefragt?', '20:32'),
    m(ch.aylin, 'Naja, nicht so direkt.', '20:32'),
    m(ch.aylin, 'Ich hab erstmal gefragt, wie sie dich findet. So… du weißt schon…', '20:33'),
    m(ch.jonas, 'Und? Sag schon, was hat sie gesagt?', '20:34'),
    m(ch.aylin, 'Nett.', '20:35'),
    m(ch.jonas, 'Nett was?', '20:36'),
    m(ch.aylin, 'Ja, nett.', '20:36'),
    m(ch.aylin, 'Ich hab auch gefragt: „Nur nett?"', '20:37'),
    m(ch.aylin, 'Und sie hat gesagt: „Ja".', '20:37'),
    typing('Jonas tippt'),
    typing('Jonas löscht'),
    m(ch.aylin, 'Zwischen euch läuft also nichts?', '20:40'),
    m(ch.jonas, 'Ähm.', '20:42'),
    m(ch.jonas, 'Nein. Gar nichts.', '20:43'),
    m(ch.aylin, 'Oh, hab ich was Falsches gesagt?', '20:44'),
  ], ['reflect-understand']),
...
const c08 = C('s1e04c08', 7, 'Amic 8', 'Im Probenraum', [
  ...
  S('s1e04c08_story_jonas_amir_musikraum', [
    ...
    m(ch.jonas, 'Du hast mich im Probenraum echt überrascht.', '16:10'),
...
const c10 = C('s1e04c10', 9, 'Amic 10', 'Das Interview', [
  ...
  S('s1e04c10_story_classChat_skatepark2', [
    classChat(),
    divider('1 Woche später'),
    m(ch.mia, 'Super Wetter heute Abend. Wer kommt zum Skatepark?', '18:05'),
    img(ch.igor, 'media/story/episodes/s1e04/s1e04c10_1-512.webp', '18:45', { reactions: [R('❤️'), R('🔥')] }),
    m(ch.yasmin, 'Ich komme auch.', '18:47'),
    m(ch.jonas, '@Amir: Du wolltest doch auch vorbei kommen. Wo bleibst du?', '18:50'),
    m(ch.amir, 'Ich komm gleich.', '18:51'),
    m(ch.jonas, 'Ich hab für die Schülerzeitung ein Interview mit Amir geführt.', '18:55'),
    m(ch.jonas, 'Vielleicht interessiert euch das auch.', '18:55'),
  ...
  S('s1e04c10_story_amir_markus_private', [
    ...
    m(ch.markus, 'Ich weiß, du willst keine Entschuldigung.', '19:00'),
    m(ch.markus, 'Aber ich hab echt Mist gebaut.', '19:00'),
    m(ch.markus, 'Als meine Mutter davon gehört hat, hätte sie fast geheult.', '19:01'),
    m(ch.markus, 'Wenn es etwas gibt, bei dem ich helfen kann oder meine Mutter: Du hast was gut.', '19:02'),
    m(ch.markus, 'Sie ist Anwältin und hat echt viel Erfahrung mit Migrationsrecht…', '19:02'),
    m(ch.markus, 'Und ich sag\'s in der Schule nicht weiter.', '19:03'),
    m(ch.amir, 'Du nimmst mich auf den Arm.', '19:04'),
    m(ch.markus, 'Du musst das Angebot nicht jetzt annehmen.', '19:05'),
    m(ch.markus, 'Meld dich einfach bei mir.', '19:05'),
    m(ch.amir, '🤨', '19:06'),
  ], ['talk-act', 'fairness']),

  S('s1e04c10_story_classChat_together', [
    classChat(),
    m(ch.markus, 'Wir kommen ja schon.', '19:10'),
    m(ch.mia, 'Wir?', '19:11'),
    img(ch.jonas, 'media/story/episodes/s1e04/s1e04c10_2-512.webp', '19:13'),
    audio(ch.chioma, 'media/story/episodes/s1e04/s1e04c10_chioma_cooles-foto.m4a', '19:14', 'Sprachnachricht'),
    m(ch.jonas, 'Danke. ☺️', '19:15'),
    img(ch.aylin, 'media/story/episodes/s1e04/s1e04c10_2-512.webp', '19:16'),
    m(ch.aylin, 'Genug geflirtet. 😊', '19:16'),
    img(ch.yasmin, 'media/story/episodes/s1e04/s1e04c10_1-512.webp', '19:20', { reactions: [R('❤️'), R('👍')] }),
